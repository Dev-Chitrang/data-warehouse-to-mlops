...
Load Silver Layer
---------------------------------------------------------------
This is a procedure that performs ETL (Extract, Tranform and Load) process to populate the data in 'silver' layer from 'bronze' layer.
Actions performed :-
1. Truncates the 'silver' tables
2. Inserts the data from 'bronze' tables into 'silver' tables 
------------------------------------
*/
...
BEGIN
	...
	PRINT '-------------------------------------------------------------------------';
	PRINT 'Loading data into silver completed';
